...
wait = {
    ...
    "cName":"IP ãƒ‡ã‚£ãƒ¼ã‚¿",
    "cName2":"ãƒ‡ã‚£ãƒ¼ã‚¿1ã¤ " , 
    "cName3":"ãƒ‡ã‚£ãƒ¼ã‚¿äºŒäºº ",
    "cName4":"ãƒ‡ã‚£ãƒ¼ã‚¿ä¸‰ ",
    "cName5":"ãƒ‡ã‚£ãƒ¼ã‚¿4äºº ",
    "cName6":"ãƒ‡ã‚£ãƒ¼ã‚¿äº” ",
    "cName7":"ãƒ‡ã‚£ãƒ¼ã‚¿6 ",
    "blacklist":{},
    "wblacklist":False,
      ...
      #-------------Fungsi Creator Start-----------------# 
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        Creatorbot = "Error"
                    cl.sendText(msg.to, "My Creator : ѕρє¢ιαℓ αиιмє/nhttp://line.me/ti/p/~kamu-jelek-banget")
                    cl.sendMessage(msg)
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Hi buddy ô€œô€…”Har Harô¿¿")
                ki2.sendText(msg.to,"Hi buddy ô€œô€…”Har Harô¿¿")
                ki3.sendText(msg.to,"Hi buddy ô€œô€…”Har Harô¿¿")

#-----------------------------------------------

            elif msg.text in ["say hinata pekok"]:
                ki.sendText(msg.to,"Hinata pekok ô€œô€…”Har Harô¿¿")
                ki2.sendText(msg.to,"Hinata pekok ô€œô€…”Har Harô¿¿")
                ki3.sendText(msg.to,"Hinata pekok ô€œô€…”Har Harô¿¿")
...
def autolike():
    ...
    if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try: 
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by: ѕρє¢ιαℓ αиιмє\n\nhttps://line.me/R/ti/p/%40kyx3655e")
            ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by: ѕρє¢ιαℓ αиιмє\n\nhttps://line.me/R/ti/p/%40kyx3655e")
            ki2.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002
            ki2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by: ѕρє¢ιαℓ αиιмє\n\nhttps://line.me/R/ti/p/%40kyx3655e")
            ki3.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002
            ki3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by: ѕρє¢ιαℓ αиιмє\n\nhttps://line.me/R/ti/p/%40kyx3655e")
            ki4.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002
            ki4.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by: ѕρє¢ιαℓ αиιмє\n\nhttps://line.me/R/ti/p/%40kyx3655e")
            ki5.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002
            ki5.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by: ѕρє¢ιαℓ αиιмє\n\nhttps://line.me/R/ti/p/%40kyx3655e")
            ki6.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002
            ki6.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by: ѕρє¢ιαℓ αиιмє\n\nhttps://line.me/R/ti/p/%40kyx3655e")
            ki7.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002
            ki7.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by: ѕρє¢ιαℓ αиιмє\n\nhttps://line.me/R/ti/p/%40kyx3655e")
            ki8.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002
            ki8.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by: ѕρє¢ιαℓ αиιмє\n\nhttps://line.me/R/ti/p/%40kyx3655e")
            ki9.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002
            ki9.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by: ѕρє¢ιαℓ αиιмє\n\nhttps://line.me/R/ti/p/%40kyx3655e")
            ki10.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002
            ki10.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by: ѕρє¢ιαℓ αиιмє\n\nhttps://line.me/R/ti/p/%40kyx3655e")
            print "Like"
        except:
            pass
    else:
