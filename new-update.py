...
cl.login(token="EmOTwxtJic6ADQjyrf51.DaUALDVPcaSnmmdSnQJEKq.o+rQf3nVP88YaXkP+Xdf4l3aL8Abd7AIeyzCU27iB6o=")
...
ki.login(token="EmFLknEU2EHGSV1rF4Me.dCW9Ku1a3Pqb1bnJhFl/ZG.FEWcPs0uV03w9brj4oWl0tIhE/1iALzyCAvZToIyuU0=")
...
kk.login(token="EmeFnyZuyoL8BWgJc4u2.54Ue5vxhzazXL1AqTT8NeG.xagy7CuZekXQfF+HoRtFY+b4DlS1rPUx9173kDEcdRM=")
...
kc.login(token="EmWxGR9O3tXP5DgQ9XB4.T2VtN7n/mDvFrkBwmVqQDa.17y9LzGPGIqfVZOwJHIzivaygD6X+p87llYZA+BRwgw=")
...
[Follow] https://instagram.com/spesial_anime07

[cek] : Membuat set point
[sider] : Melihat sider dibawah read point
[Creator] : Melihat kontak pembuat bot

[Set group] : Privasi grup
[Gn namagroup] : Ganti nama group
[Open url] : Membuka url group
[Close url] : Menutup url group
[Cancel] : Cancel user masuk group
[Hack Instagram] https://line.me/R/ti/p/%40kyx3655e
[Agen Kuota Gratis] https://line.me/R/ti/p/%40kyx3655e
[Website Kami]
[Artikel Kesehatan] www.ppniindonesia.net
[Mobile Apps] mobile-apps.zone.id
"""
KAC=[cl,ki,kk,kc]
DEF=[ki,kk,kc]
...
Bots=[mid,Amid,Bmid,Cmid,"u30ef8888fc6633edaef95fe68c686c48", "u0780036f5bcdc4186a5174b254cf0df5","u0dcc3d914d40de9401d413631df2fece","ue78b84e555c7640671975690b6df2712","ub76bd39fb37e31d55f44a6d632f42a74"]
admin=["u30ef8888fc6633edaef95fe68c686c48","u740b9a95dbe9080b0d30c0ec36a8de91"]
admsa=["u30ef8888fc6633edaef95fe68c686c48"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"Thanks for adding Girl https://line.me/R/ti/p/%40kyx3655e",
    "lang":"JP",
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u30ef8888fc6633edaef95fe68c686c48":
                    if "join:" in msg.text:
...
#-----------------------------------------------
    ...
    #-------------Fungsi Tag All Finish---------------#
         ...
         #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in Bots:
                if msg.toType == 2:
                    ...
                    kk.sendText(msg.to,"makasih semuanya sudah inved saya")
                        ...
                        for target in targets:
                          if target not in Bots:
                            try:
                                ...
                                ki.sendText(msg.to,"Follow Instagram Kami https://instagram.com/spesial_anime07")
       ...
       #--------------Fungsi Broadcast Finish-----------#
                ...
                ki.sendText(msg.to,"Hi Juga beb")
                kk.sendText(msg.to,"Hi yank")
                kc.sendText(msg.to,"Kok baru nyapa")

#-----------------------------------------------

            elif msg.text in ["Kangen"]:
                ki.sendText(msg.to,"Sama Yank dd juga kangen")
                kk.sendText(msg.to,"Sini beb peluk aku kalau kangen")
                kc.sendText(msg.to,"Aku Juga kangen lo sayang")
            ...
            elif msg.text in ["Say bobo yuk","Bobo dulu ah"]:
                ki.sendText(msg.to,"Ikut yank")
                kk.sendText(msg.to,"Bareng aku ya bobok nya")
                kc.sendText(msg.to,"Yuk beb bobok kita")
     ...
     for zx in range(0,20):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
			...
			kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ѕρє¢ιαℓ αиιмє https://line.me/R/ti/p/%40kyx3655e")
			kc.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
			kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ѕρє¢ιαℓ αиιмє https://line.me/R/ti/p/%40kyx3655e")
			print "Like"
          except:
            pass
        else:
